...
.ソフトウェアバージョン
. ONTAP 9.8 以降
. Active IQ Unified Manager (Unified Manager) 9.10以降9.16P2未満
...
. Unified Managerのバージョンが9.10以降9.16P2より前のバージョンに設定されていることを確認してください。Unified Managerのインストール方法については、以下のリンクを参照してください。
+
